        ...
        <div class="max-w-4xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="rounded-xl bg-white p-6 shadow">
                <form action="{{ route('jobs.store') }}" method="POST" class="space-y-5">
                    @csrf
                    @include('jobs.partials.form', ['job' => null, 'projects' => $projects])

                    <div class="flex justify-end gap-3">
                        <a href="{{ route('jobs.index') }}" class="inline-flex items-center rounded border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-50">
                            Cancel
                        </a>
